...
const Hero = () => {
  return <div className="relative min-h-screen flex items-center justify-center bg-[#FDE1D3]">
      ...
      <div className="relative container mx-auto px-4 text-center">
        ...
        <Button size="lg" className="bg-[#FEC6A1] hover:bg-[#FEC6A1]/90 text-gray-900" onClick={() => document.getElementById('about')?.scrollIntoView({
        behavior: 'smooth'
      })}>
          Learn More
        </Button>
