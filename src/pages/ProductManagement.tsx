...
export default function ProductManagement() {
  ...
  useEffect(() => {
    ...
    if (!user && !isLoading) {
      ...
      navigate("/login", { 
        state: { redirectAfterLogin: "/admin/products", message: "Please log in to access product management" }
      });
      return;
    }
      ...
      <div className="flex pt-16">
        ...
        <main className={`flex-1 transition-all p-6 ${isSidebarOpen ? "md:ml-64" : "md:ml-16"}`}>
          <div className="max-w-7xl mx-auto">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-[#8B7355] mb-2">Product Management</h1>
